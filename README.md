# Roma
[![GitHub release](https://img.shields.io/github/release/roma-apps/roma-desktop.svg)](https://github.com/roma-apps/roma-desktop/releases)

Roma is a mastodon client for desktop application.
...
You can download `.exe` from [release page](https://github.com/roma-apps/roma-desktop/releases).
